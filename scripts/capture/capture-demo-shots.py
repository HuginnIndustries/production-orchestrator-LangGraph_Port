...
- A 1920x1080 viewport is recorded into a matching 1920x1080 video surface.
  Playwright records CSS viewport pixels rather than device-scale pixels; requesting
  a 3840x2160 video for a 1920x1080 viewport pads three quadrants with gray.
"""
...
OUT = Path("/tmp/po-captures-1080p")
